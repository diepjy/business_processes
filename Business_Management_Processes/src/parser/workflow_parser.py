...
class WorkflowParser(object):
    ...
    # Parse tasks and store task options in the symbol table
    ...
    # Parse rules such as duration, min_sec_lv
    ...
    def main(self, prompt_input):
        ...
        lexer = lex(module=WorkflowLexer(), optimize=1)
        parser = yacc(module=WorkflowParser(), start='prog', optimize=1)
        ...
        smt_output = \
            WorkflowParser.smt_sort_task + \
            WorkflowParser.smt_sort_user + \
            WorkflowParser.smt_fun_executed + \
            WorkflowParser.smt_fun_before + \
            WorkflowParser.smt_fun_seniority + \
            WorkflowParser.smt_const_bottom + \
            WorkflowParser.smt_fun_alloc_user + \
            WorkflowParser.smt_fun_duration + \
            WorkflowParser.smt_before_transitivity + \
            WorkflowParser.smt_fun_seniority_transitivity +\
            WorkflowParser.smt_users_neq_bottom + \
            WorkflowParser.smt_acyclic_before + \
            WorkflowParser.smt_acyclic_seniority
        ...
        try:
            ...
            # There was a syntax error and users and tasks were not allocated into symbol table
            return "syntax error"
        ...
        # End benchmarking for generating the model
    ...
    def worst_time_completion(self, x, delta, s):
        ...
        WorkflowParser.worst_time_completion_list = worst_time_completion_tasks
        print WorkflowParser.worst_time_completion_list
